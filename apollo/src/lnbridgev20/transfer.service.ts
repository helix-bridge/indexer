...
export class TransferService extends BaseTransferServiceT1 {
  private readonly goerliArb2EthLnv2Endpoint = this.configService.get<string>(
    'GOERLI_A2E_LNV2_ENDPOINT'
  );
  private readonly arbitrumGoerliArb2EthLnv2Endpoint = this.configService.get<string>(
