...
export abstract class IQuery {
    ...
    abstract historyRecords(sender?: Nullable<string>, recipient?: Nullable<string>, fromChain?: Nullable<string>, toChain?: Nullable<string>, row?: Nullable<number>, page?: Nullable<number>, results?: Nullable<Nullable<number>[]>): Nullable<HistoryRecords> | Promise<Nullable<HistoryRecords>>;
